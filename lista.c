...
// Definir el struct
typedef struct { //typedef int TIPOELEMENTOLISTA;
char alias[MAX_NAME_LENGTH]; // también podemos poner char *alias;
char rol;//este es el rol del jugador
TCOLA tareas; //la cola de tareas. TCOLA está en el cola.h
} TIPOELEMENTOLISTA;
///////////////////////////////////////////////////
